(() => {
  ...
  agregarProducto(bolsoWp)
    ...
    // selectores
      const insertProducts = document.getElementById('insertProducts'),
          ...
          nameProd = document.querySelectorAll('nombreProd').values,
          boxProduct = document.querySelectorAll('boxProduct'),
          arrCart = [];
      ...
      const dibujaProductos = () => {
        ...
        addToCart = () => {
          ...
          //   let productito = productos[i];
          //   console.log(productito)
          // }
        //   console.dir(nameProd)
        //  return productos.map(element => {
        //    console.log(element.categoria)
        //     // arrCart.push(nameProd);
        //     // console.log(arrCart)
        //   });
  ...
  //       arrCart.push(pro[i].attributes.id.value)
  //       console.log(arrCart)
